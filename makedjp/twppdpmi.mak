...
C_DEBUG_FLAGS=
C_OPT_FLAGS=-O3
C_WARN_FLAGS=-pedantic -pedantic-errors
C_C_LANG_FLAGS=
C_CXX_LANG_FLAGS=
C_P_LANG_FLAGS=
C_F_LANG_FLAGS=
...
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))
OBJFILES=abends.o globals.o twpair.o twport.o twppfind.o twremaps.o\
	twsector.o twwarp.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
...
MAIN_TARGET=twppdpmi.exe
PROJECT_ITEMS=abends.cpp globals.cpp twpair.cpp twport.cpp twppfind.cpp\
	twremaps.cpp twsector.cpp twwarp.cpp
%.o: %.c
	$(RHIDE_COMPILE.c.o)
%.o: %.i
	$(RHIDE_COMPILE_C)
...
all:: twppdpmi.exe
DEPS_0=\
		h:/twports/dos/abends.o\
		h:/twports/dos/globals.o\
		h:/twports/dos/twpair.o\
		h:/twports/dos/twport.o\
		h:/twports/dos/twppfind.o\
		h:/twports/dos/twremaps.o\
		h:/twports/dos/twsector.o\
		h:/twports/dos/twwarp.o
NO_LINK=
